...
public class MainTest {// classe para debug
    ...
    public static void main(String[] args) {
         ...
         * System.out.println("Vida inicial de " + ares.getNome() + ": " +
         * ares.getPontosvida());
         * 
         * ares.atacar(hefesto);
         * 
         * System.out.printf("\nVida de %s após ataque (esperado aumento): %.1f%n",
         * ares.getNome(), ares.getPontosvida());
         * separador();
         */
         ...
         * System.out.println("Vigor atual de " + hefesto.getNome() + ": " +
         * hefesto.getVigor());
         * 
         * // Ataque 1: Hefesto tem vigor (deve bloquear o dano completamente e perder
         * vigor)
         * System.out.println(">> Ataque 1: " + apolo.getNome() + " ataca " +
         * hefesto.getNome());
         ...
         * System.out.println("\n>> Hack: Zerando vigor de " + hefesto.getNome() +
         * " para teste...");
         * System.out.println(">> Ataque 2: " + apolo.getNome() + " ataca " +
         * hefesto.getNome() + " (Sem Vigor)");
         * apolo.atacar(hefesto);
         * separador();
         */
         ...
         * System.out.println("Vida atual de " + apolo.getNome() + ": " +
         * apolo.getPontosvida());
