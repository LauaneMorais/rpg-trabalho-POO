...
public class TelaBatalha extends JFrame {
    ...
    private void aplicarBuff() {
        // CORRIGIDO: Removido br.com.ascensao e usado o import util.ChanceBuff
        if (ChanceBuff.Chance()) {
            // CORRIGIDO: Removido br.com.ascensao
            SorteioBuff.aplicarBuffAleatorio(amigo);
            String nomeDeus = SorteioBuff.aplicarBuffAleatorio(amigo);
    ...
    try {
        // CORRIGIDO CAMINHO:
        java.net.URL url = getClass().getResource("/assets/" + nomeArquivo);
